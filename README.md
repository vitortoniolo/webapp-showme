...
- SMITH, John. *The Independent Music Economy*. Routledge, 2019.  
- GARCIA, Ana; LOPES, Paulo. *Consumo Cultural e Plataformas Digitais*. São Paulo: Edusp, 2021.  
...
Na cena musical local, existe uma carência de ferramentas digitais que centralizem informações sobre shows e eventos culturais, em especial os de pequeno e médio porte. Atualmente, esses eventos dependem fortemente de redes sociais ou da divulgação boca a boca, o que dificulta seu alcance. A solução proposta é o desenvolvimento de uma plataforma web que permita a divulgação, organização e descoberta desses eventos de forma acessível e integrada. Com isso, espera-se ampliar o alcance dos artistas e organizadores e facilitar o acesso do público interessado, criando um ecossistema mais conectado e eficiente.

## Definição do Problema

A ausência de ferramentas centralizadas para a divulgação de shows e eventos culturais locais cria barreiras tanto para artistas quanto para frequentadores. Pesquisas em áreas de economia criativa apontam que a falta de visibilidade é um dos principais fatores que prejudicam artistas independentes (Smith, 2019). Além disso, estudos sobre consumo cultural mostram que grande parte do público interessado em eventos alternativos ou independentes acaba não tendo acesso a essas informações por falta de canais de comunicação adequados (Garcia & Lopes, 2021).  

Os sistemas atualmente disponíveis (como Facebook Events ou plataformas pagas de ticketing) não se adequam completamente a esse público, seja pela baixa adesão ou pela complexidade de uso.  

Assim, a solução proposta busca centralizar informações de eventos locais, trazendo mais praticidade e alcance para organizadores e maior facilidade de descoberta para usuários.  

*Tabela comparativa (exemplo simplificado):*

| Plataforma       | Público alvo | Facilidade de uso | Custo para organizadores | Foco em eventos locais |
|------------------|--------------|-------------------|--------------------------|-------------------------|
| Facebook Events  | Geral        | Médio             | Gratuito                 | Baixo                  |
| Sympla           | Geral        | Médio             | Pago                     | Médio                  |
| Projeto Proposto | Local/cultural | Alto             | Gratuito                 | Alto                   |
...
- **Backend:** FastAPI (Python)  
- **Banco de Dados:** PostgreSQL  
- **Orquestração e Deploy:** Docker Compose e Kubernetes (para ambientes de staging/produção)  
- **Infraestrutura em Nuvem:** Google Cloud Platform (Artifact Registry, Kubernetes Engine)  
- **Versionamento de Código:** GitHub  
- **CI/CD:** GitHub Actions  

*(descrição detalhada de cada tecnologia pode ser expandida futuramente com referências e justificativas)*
...
- Integração com APIs externas (Spotify, Google Maps).  
- Criação de aplicativo mobile.  
- Expansão para eventos de outras áreas culturais além da música.  
